...
export default function CustomizedDialogs() {
    ...
    const dataLXNTV = ['Bảo lưu', 'Đang học', 'Chờ xét HTCT', 'Chờ xét TN', 'Hoàn tất CT', 'Xác nhận TGH', 'Giới thiệu', 'Vay vốn'];
    ...
    return (
        <div>
            ...
            <Dialog onClose={handleClose} aria-labelledby="customized-dialog-title" open={open}>
                ...
                <DialogContent>
                    <div style={{display: 'flex', alignItems: 'baseline', justifyContent: 'space-between'}}>
                        <span style={{minWidth: 'fit-content', alignSelf: 'center'}}>Ngôn ngữ</span>
                        ...
                        {dataNgonNgu[NgonNgu] === 'Tiếng Việt' && (
                            <div style={{display: 'flex', alignItems: 'baseline', justifyContent: 'space-between'}}>
                                <span style={{minWidth: 'fit-content', alignSelf: 'center'}}>Loại xác nhận</span>
                                <FormControl variant="outlined" className={classes.formControl}>
                                    <Select
                                        value={LXN}
